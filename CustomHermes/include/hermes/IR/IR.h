...
class Value {
 ...
 private:
  ...
  bool function = false;
  bool taint = false;
  bool taintSource = false;
  bool taintSink = false;
  bool JSObject = false;
  bool URL = false;

  llvh::StringRef URLStr = llvh::StringRef("");
  llvh::StringRef JSObjectStr = llvh::StringRef(""); // taint property 또는 method의 원 object 변수명을 지정
  llvh::StringRef JSPropertyStr = llvh::StringRef("");
  hermes::Function* functionPtr;
 ...
 public:
  ...
  void setJSObject(llvh::StringRef obj)
  {
    this->JSObject = true;
    this->JSObjectStr = obj;
  }

  void setJSProperty(llvh::StringRef prop)
  {
    this->JSPropertyStr = prop;
  }

  void setURL(llvh::StringRef str)
  {
    this->URL = true;
    this->URLStr = str;
  }

  void setFunction(hermes::Function* func)
  {
    this->function = true;
    this->functionPtr = func;
  }

  llvh::StringRef getJSObject()
  {
    return this->JSObjectStr;
  }

  llvh::StringRef getJSProperty()
  {
    return this->JSPropertyStr;
  }

  llvh::StringRef getURL()
  {
    return this->URLStr;
  }

  hermes::Function* getFunction()
  {
