...
#ifndef HERMES_OPTIMIZER_SCALAR_CUSTOM_CALLGRAPH_PROVIDER_H
#define HERMES_OPTIMIZER_SCALAR_CUSTOM_CALLGRAPH_PROVIDER_H
...
class CustomCallGraphProvider : public CallGraphProvider {
  void initCallRelationships(Function *F);

 public:
  CustomCallGraphProvider(Function *F) {
