...
class TrackerTracker {
    ...
    async init({log}) {
        ...
        try {
            ...
            console.log("Error occured in TrackerTracker during initiaion")
        }
    }
    ...
    async _addBreakpoint(expression, condition, description, contextId, saveArguments) {
        try {
            ...
            if (
                ...
                //console.log('Setting breakpoint failed')
            }
        }
    }
    ...
    processDebuggerPause(params) {
        ...
        //console.log(payload)
        const breakpoint = this._getBreakpointByName(payload.description); // 어느 코드에서 api가 호출되었는지 확인
