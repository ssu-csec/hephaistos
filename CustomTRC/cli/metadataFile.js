 ...
 */
function createMetadataFile(outputPath, {startTime, endTime, urls, successes, failures, skipped, numberOfCrawlers, filterOutFirstParty, dataCollectors, fatalError, emulateMobile, proxyHost, regionCode, failureLog}) {
    const filePath = path.join(outputPath, METADATA_FILE_NAME);
